...
void logoshow(void);
void display_uwb(struct MyLink*);
void send_udp(String*);

const char *ssid = "sfz Wangen";
const char *password = "Lo9In$fzWangen";
const char *host = "192.168.34.67";
WiFiClient client;
...
void setup()
{
    ...
    // Definitv eine sichere GET-Request und so
...
/* Funktion mit der die neue Reichweite bestimmt wird
 * Erzeugt einen neuen link
 */
void newRange()
{
    char c[30];
...
/* Funktion mit der ein neuer Tag erkannt wird
 * Fügt den Tag in die Liste der Verbindungen hinzu
 */
...
/* Funktion mit der ein inaktiver Link entfernt wird
